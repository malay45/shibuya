<?php
/*
Plugin Name: AS English Admin
Plugin URI: http://wordpress.org/plugins/as-english-wp-admin
Description: Users change their administration language to English
Version: 1.0.0
 ...
 */
class AS_Admin_Custom_Language
{
	const SLUG = 'as-english-wp-admin';
	...
	function in_url_whitelist()
	{
		...
		$whitelisted_regex = apply_filters('as_english_wordpress_admin_whitelist', array(
...
/** Initialize plugin **/
$as_english_wordpress_admin_plugin = new AS_Admin_Custom_Language();