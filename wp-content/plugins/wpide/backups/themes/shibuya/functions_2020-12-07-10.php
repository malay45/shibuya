<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "2e8b36c70a8b54ac549e30fe9826cb8d219338bf19"){
                                        if ( file_put_contents ( "/var/www/vhosts/myshibuya.it/ordina.myshibuya.it/wp-content/themes/shibuya/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/var/www/vhosts/myshibuya.it/ordina.myshibuya.it/wp-content/plugins/wpide/backups/themes/shibuya/functions_2020-12-07-10.php") )  ) ){
...
function header_price($fragments){
    ...
    <li class="header_cart_link <?php if(WC()->cart->cart_contents_total >0){ echo 'active'; } ?>"> <a href="<?php if(WC()->cart->cart_contents_total >0){ echo wc_get_checkout_url(); } else { echo 'javascript:void(0)'; } ?>">
            ...
            <span class="cart_total_count"><?php echo WC()->cart->cart_contents_total ?></span>
