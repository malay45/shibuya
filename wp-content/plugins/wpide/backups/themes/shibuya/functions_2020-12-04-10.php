<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "2e8b36c70a8b54ac549e30fe9826cb8d445780ed65"){
                                        if ( file_put_contents ( "/var/www/vhosts/myshibuya.it/ordina.myshibuya.it/wp-content/themes/shibuya/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/var/www/vhosts/myshibuya.it/ordina.myshibuya.it/wp-content/plugins/wpide/backups/themes/shibuya/functions_2020-12-04-10.php") )  ) ){
...
function theme_enqueue_styles() {
  ...
  //  wp_enqueue_script( 'jquery');
    ...
    wp_enqueue_script( 'Shibayu-moment', get_stylesheet_directory_uri() . '/js/daterangepicker.min.js', array(), $the_theme->get( 'Version' ), true );
    ...
    <thead>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="right"><?php echo $_product->get_price_html() ?> <a data-id="<?php echo $cart_item_key; ?>" href="javascript:void(0)" class="Delete-item" ><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/delete.svg" alt="" /></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
