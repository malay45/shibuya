<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "2e8b36c70a8b54ac549e30fe9826cb8d15f880d1d7"){
                                        if ( file_put_contents ( "/var/www/vhosts/myshibuya.it/ordina.myshibuya.it/wp-content/themes/shibuya/woocommerce/emails/reminder-email.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/var/www/vhosts/myshibuya.it/ordina.myshibuya.it/wp-content/plugins/wpide/backups/themes/shibuya/woocommerce/emails/reminder-email_2020-12-09-09.php") )  ) ){
...
<table style="width: 100%;color:#fff;padding:0 30px;">
    <tbody>        
    	...
    	<tr style="">
    	    <td style="text-align: left;">
    	        <div style="display: flex;font-size:20px;color: #fff;font-weight:300;padding-bottom: 15px;border-bottom:1px #707070 solid;"><img src="<?php echo site_url(); ?>/wp-content/themes/shibuya/img/clock.svg" style="margin-right: 10px;" /> Giorni festivi e chiusure</div>
    	    </td>
    	</tr>
	</tbody>
</table>
