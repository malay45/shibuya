<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "2e8b36c70a8b54ac549e30fe9826cb8dccfe2c8845"){
                                        if ( file_put_contents ( "/var/www/vhosts/myshibuya.it/ordina.myshibuya.it/wp-content/themes/shibuya/woocommerce/emails/reminder-email.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/var/www/vhosts/myshibuya.it/ordina.myshibuya.it/wp-content/plugins/wpide/backups/themes/shibuya/woocommerce/emails/reminder-email_2020-12-09-08.php") )  ) ){
...
<table style="width: 100%;color:#fff;padding:15px 30px 25px;border-bottom:1px #707070 solid;">
    <tbody>
        ...
        <?php endforeach; ?>
        <tr>
            <td style="font-size:14px;color: #fff;font-weight:400;text-align: left;padding:15px 0 0;border-top:1px #707070 solid;">Total</td>
        ...
        <tr>
            <td style="font-size:14px;color: #fff;font-weight:400;text-align: left;">Text</td>
            <td style="font-size:14px;color: #fff;font-weight:400;text-align: right;"><?php echo wc_price($order->get_total_tax()); ?></td>
        </tr>
        <tr>
            <td style="font-size:16px;color: #fff;font-weight:bold;text-align: left;padding:20px 0 10px;">Total</td>
...
<table style="width: 100%;color:#fff;text-align:center;background:#414141;margin-top:40px;padding:30px;">
    <tbody>
        <tr>
            <td style="font-size:18px;color: #fff;font-weight:bold;padding-bottom: 10px;">Contact Details</td>
        </tr>
        <tr>
            <td>
            ...
            <tr>
                <td style="text-align: right;width: 50%;">
                    <a href="http://www.myshibuya.it/">
                        <img src="<?php echo site_url(); ?>/wp-content/themes/shibuya/img/Icon-facebook.svg" style="margin-right: 10px;" alt="" />
                    </a>
                </td>
                <td style="text-align: left;width: 50%;">
                    <a href="http://www.myshibuya.it/">
                        <img src="<?php echo site_url(); ?>/wp-content/themes/shibuya/img/Icon-instagram.svg" style="margin-left: 10px;" alt="" />
                    </a>
                </td>
            </tr>
            <tr>
