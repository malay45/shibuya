<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "2e8b36c70a8b54ac549e30fe9826cb8d2813c5158e"){
                                        if ( file_put_contents ( "/var/www/vhosts/myshibuya.it/ordina.myshibuya.it/wp-content/themes/shibuya/woocommerce/emails/reminder-email.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/var/www/vhosts/myshibuya.it/ordina.myshibuya.it/wp-content/plugins/wpide/backups/themes/shibuya/woocommerce/emails/reminder-email_2020-12-08-19.php") )  ) ){
...
<table style="width: 100%;">
	<tr>
		<td style="text-align: center;padding: 20px;">
			...
			<img src="https://ordina.myshibuya.it/wp-content/uploads/2020/11/Uramaki-California.jpg" />
		</td>
	</tr>
</table>
<table style="width: 100%;color:#fff;">
	<tr>
		<td style="text-align: center;">
			<h1>Oggi puoi ritirare il tuo ordine!</h1>
		</td>
	<tr>
	<tr>
		<td style="text-align: center;">
			<h5><span>Numero ordine:</span><span><?php echo $order->get_id() ?></span> | <span>Data de Order <?php  echo strftime("%e %B %Y",strtotime($order->order_date)); ?></span></h5>
		</td>
	</tr>
	<tr>
	    <td style="text-align: center;">
	...
	<tr>
	    <td style="text-align: center;">
			grazie per aver ordinato il sushi di MyShibuya!
	...
	<tr style="">
	    <td style="text-align: center;">
	        <div>Ti ricordiamo che <?php echo get_the_title($metas['location_id'][0]); ?> effettua i seguenti orari di apertura e che il tuo ordine sarà ritirabile solo nel giorno che hai scelto.
	        </div>
	    </td>
	</tr>
	<tr style="">
	    <td style="text-align: left;">
	        <div><img src="<?php echo site_url(); ?>/wp-content/themes/shibuya/img/clock.svg" /> Orario di apertura</div>
	    </td>
	</tr>
</table>
<table style="width: 100%;color:#fff;">
