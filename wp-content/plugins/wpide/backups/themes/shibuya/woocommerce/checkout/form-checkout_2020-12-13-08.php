<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "1045e2434da35184e05d00fdaa76158d4fdbc68434"){
                                        if ( file_put_contents ( "/var/www/vhosts/myshibuya.it/ordina.myshibuya.it/wp-content/themes/shibuya/woocommerce/checkout/form-checkout.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/var/www/vhosts/myshibuya.it/ordina.myshibuya.it/wp-content/plugins/wpide/backups/themes/shibuya/woocommerce/checkout/form-checkout_2020-12-13-08.php") )  ) ){
                ...
                <div class="col-lg-6 col-12">
                    <div class="Number-verification" data-id="<?php echo $_SESSION['otp']  ?>">
                        ...
                        <div class="Flex-col space-between">
                            <input type="text" class="form-control otp-number" name="otp-number"  value="" /> <button href="javascript:void(0)" class="Send-sms-btn"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/sms.svg" alt="">Invia codice di verifica</button>
