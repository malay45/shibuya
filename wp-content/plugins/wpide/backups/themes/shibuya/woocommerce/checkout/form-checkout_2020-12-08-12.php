<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "2e8b36c70a8b54ac549e30fe9826cb8d2813c5158e"){
                                        if ( file_put_contents ( "/var/www/vhosts/myshibuya.it/ordina.myshibuya.it/wp-content/themes/shibuya/woocommerce/checkout/form-checkout.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/var/www/vhosts/myshibuya.it/ordina.myshibuya.it/wp-content/plugins/wpide/backups/themes/shibuya/woocommerce/checkout/form-checkout_2020-12-08-12.php") )  ) ){
                ...
                <div class="row">
                    <div class="col-lg-6 col-12">
                            ...
                            <form action="">
                                ...
                                <div class="row">
                                    <div class="col-12 padding-15">
                                        ...
                                        <span class="txt">Desidero ricevere novità e promozioni. <a href="">Privacy Policy</a></span>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="Flex-col space-between align-items"> 
                                <span class="txt">Per ulteriori informazioni consulta la nostra <a href="">Privacy policy</a> e <a href="">Cookie policy</a></span>
                                <div class="form-group margin-0">
                        ...
                        <span class="location_address"><?php echo $location_global['address']; ?></span>
                            ...
                            <div class="col-sm-6 col-12">
                                ...
                                ?>
                                    ...
                                    <input name="pickup_date" class="pickup_date form-control"
                                        data-dd-max-date="<?php echo date('m/d/Y',strtotime("+$end day")); ?>"
                                        data-dd-min-date="<?php echo ($start<1)?date('m/d/Y'):date('m/d/Y',strtotime("+$start day")); ?>"
                                        data-dd-default-date="<?php echo ($start<1)?date('m/d/Y'):date('m/d/Y',strtotime("+$start day")); ?>"
                                        value="<?php echo ($start<1)?date('Y-m-d'):date('Y-m-d',strtotime("+$start day")); ?>"    
                                    />
                                </div>
                            </div>
                        </div>
