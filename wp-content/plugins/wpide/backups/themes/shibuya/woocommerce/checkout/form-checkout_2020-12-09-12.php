<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "2e8b36c70a8b54ac549e30fe9826cb8de93a365c0f"){
                                        if ( file_put_contents ( "/var/www/vhosts/myshibuya.it/ordina.myshibuya.it/wp-content/themes/shibuya/woocommerce/checkout/form-checkout.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/var/www/vhosts/myshibuya.it/ordina.myshibuya.it/wp-content/plugins/wpide/backups/themes/shibuya/woocommerce/checkout/form-checkout_2020-12-09-12.php") )  ) ){
                            ...
                            <div class="col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <div class="Place-detail">
                                        <p> <b class="location_title_"><?php global $location_global;
                                                  //  echo $location_global['title']; 
                                              ?>
                            ...
                            <div class="col-sm-6 col-12">
                                ...
                                ?>
                                    ...
                                    <input name="" class="pickup_date form-control"
                                        ...
                                        data-dd-default-date="<?php date('m/d/Y',strtotime("+$start day")); ?>"
                                        value="<?php echo strftime("%e %B %Y",strtotime("+$start day")); ?>"   
