<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "2e8b36c70a8b54ac549e30fe9826cb8d78d00d04a8"){
                                        if ( file_put_contents ( "/var/www/vhosts/myshibuya.it/ordina.myshibuya.it/wp-content/themes/shibuya/woocommerce/checkout/form-checkout.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/var/www/vhosts/myshibuya.it/ordina.myshibuya.it/wp-content/plugins/wpide/backups/themes/shibuya/woocommerce/checkout/form-checkout_2020-12-04-19.php") )  ) ){
                            ...
                            <div class="col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <select name="pickup_date" id="" class="form-control">
                                        <option value="test">Seleziona la data</option>
                                    </select>
                                </div>
                            </div>
                        </div>
