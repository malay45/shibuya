<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "2e8b36c70a8b54ac549e30fe9826cb8d15f880d1d7"){
                                        if ( file_put_contents ( "/var/www/vhosts/myshibuya.it/ordina.myshibuya.it/wp-content/themes/shibuya/footer.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/var/www/vhosts/myshibuya.it/ordina.myshibuya.it/wp-content/plugins/wpide/backups/themes/shibuya/footer_2020-12-09-06.php") )  ) ){
...
<section class="Location-selection-modal" style="display:none;">
            <div class="Outer-cell">
                <div class="Inner-cell">
                    <div>
                        ...
                        <div class="Selection-wrapp">
                            <div class="dropdown "> <a class="btn btn-secondary dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                ...
                foreach($location as $location_data):
                    $address = get_post_meta($location_data->ID,'address',true);
                    $location_array[] = array(
                        'id' => $location_data->ID,
