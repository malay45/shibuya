<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "2e8b36c70a8b54ac549e30fe9826cb8d72d3a0b211"){
                                        if ( file_put_contents ( "/var/www/vhosts/myshibuya.it/ordina.myshibuya.it/wp-content/themes/shibuya/template-productlist.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/var/www/vhosts/myshibuya.it/ordina.myshibuya.it/wp-content/plugins/wpide/backups/themes/shibuya/template-productlist_2020-11-23-19.php") )  ) ){
...
<div style="margin : 50px auto;max-width : 500px">
    <form name="product_create" method="POST">
        ...
        <div>
            ...
            <input type="hidden" name="_media_id" id="media_id" />
        </div>
        <div>
