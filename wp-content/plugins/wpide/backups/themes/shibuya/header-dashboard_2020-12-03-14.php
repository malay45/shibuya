      ...
      <div class="Flex-col Flex-end">
        <ul class="navbar-nav">
          <li>
            <a href="" class="Notification">
              <img src="https://ordina.myshibuya.it/wp-content/themes/shibuya/img/notifications.svg" alt="">
              <span></span>
            </a>
          </li>
        </ul>
        <div class="dropdown">
          <a class="btn btn-secondary dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <span>Nome Utente</span><img src="https://ordina.myshibuya.it/wp-content/themes/shibuya/img/user-circle.svg" alt="">
          </a>
