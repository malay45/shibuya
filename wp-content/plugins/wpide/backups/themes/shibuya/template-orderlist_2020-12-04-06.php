<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "2e8b36c70a8b54ac549e30fe9826cb8d445780ed65"){
                                        if ( file_put_contents ( "/var/www/vhosts/myshibuya.it/ordina.myshibuya.it/wp-content/themes/shibuya/template-orderlist.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/var/www/vhosts/myshibuya.it/ordina.myshibuya.it/wp-content/plugins/wpide/backups/themes/shibuya/template-orderlist_2020-12-04-06.php") )  ) ){
        ...
        if ( $loop->have_posts() ) {
            ...
            ?>
              <tr>
                ...
                <td><span class="label-Inprocess <?php echo  wc_get_order_status_name($order->get_status()); ?>"><?php echo $order->get_status(); ?></span></td>
