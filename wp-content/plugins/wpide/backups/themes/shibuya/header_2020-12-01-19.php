<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "2e8b36c70a8b54ac549e30fe9826cb8db89437034e"){
                                        if ( file_put_contents ( "/var/www/vhosts/myshibuya.it/ordina.myshibuya.it/wp-content/themes/shibuya/header.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/var/www/vhosts/myshibuya.it/ordina.myshibuya.it/wp-content/plugins/wpide/backups/themes/shibuya/header_2020-12-01-19.php") )  ) ){
                ...
                <div class="Flex-col space-between">
                    ...
                    <ul class="Menu">
                        ...
                        <li> <a href="">
                            ...
                            <span class="header_location_title">Reggio SUD</span>
                        </a>
                        ...
                        <li> <a href="">
                            ...
                            <span class="cart_total_text">12,50 €</span>
                        </a>
