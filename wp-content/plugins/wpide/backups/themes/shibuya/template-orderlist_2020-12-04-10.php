<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "2e8b36c70a8b54ac549e30fe9826cb8d445780ed65"){
                                        if ( file_put_contents ( "/var/www/vhosts/myshibuya.it/ordina.myshibuya.it/wp-content/themes/shibuya/template-orderlist.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/var/www/vhosts/myshibuya.it/ordina.myshibuya.it/wp-content/plugins/wpide/backups/themes/shibuya/template-orderlist_2020-12-04-10.php") )  ) ){
...
<div class="Content-Wrapper">
      ...
      <div class="Filter-wrapper">
        <form action="<?php the_permalink(); ?>" mehod="POST">
          <div class="row">
            ...
            <div class="col-3">
              <div class="form-group">
                ...
                <input name="" type="text" value="Seleziona intervallo di tempo" placeholder="Seleziona intervallo di tempo" class="form-control datepicker-dummy" />
                <input name="start_date" id="start_date" type="hidden" />
                <input name="end_date" id=""  type="hidden"  />
              </div>
            </div>
            <div class="col-3">
              <div class="form-group">
