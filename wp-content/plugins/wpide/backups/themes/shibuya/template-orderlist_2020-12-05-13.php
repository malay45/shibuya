<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "2e8b36c70a8b54ac549e30fe9826cb8d755764fd2d"){
                                        if ( file_put_contents ( "/var/www/vhosts/myshibuya.it/ordina.myshibuya.it/wp-content/themes/shibuya/template-orderlist.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/var/www/vhosts/myshibuya.it/ordina.myshibuya.it/wp-content/plugins/wpide/backups/themes/shibuya/template-orderlist_2020-12-05-13.php") )  ) ){
      ...
      <div class="Data-table Table-wrapper">
        ...
        if ( $loop->have_posts() ) {
              ...
              <tr>
                ...
                <td align="right">
                  <div class="Flex-col flex-end">
                    <a href="<?php echo $edit_link; ?>?id=<?php  the_ID(); ?>"><img src="<?php echo site_url(); ?>/wp-content/themes/shibuya/img/edit-icon.svg" alt="" /></a>
                    <a class="product_delete" href="javascript:void(0)" onclick="delete_order(<?php  the_ID(); ?>)" data-id="<?php  the_ID(); ?>">
                        <img src="<?php echo site_url(); ?>/wp-content/themes/shibuya/img/delete-icon.svg" alt="" />
                    </a>
                  </div>
                </td>
              </tr>
          ...
          <?php
            ...
            echo __( '<tr><td>No orders found</td></tr>' );
        }
        wp_reset_postdata();
        ?>
            </tbody>
