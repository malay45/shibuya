<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "2e8b36c70a8b54ac549e30fe9826cb8d4981022977"){
                                        if ( file_put_contents ( "/var/www/vhosts/myshibuya.it/ordina.myshibuya.it/wp-content/themes/shibuya/template-productlist.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/var/www/vhosts/myshibuya.it/ordina.myshibuya.it/wp-content/plugins/wpide/backups/themes/shibuya/template-productlist_2020-11-24-07.php") )  ) ){
        ...
        if ( $loop->have_posts() ) {
            while ( $loop->have_posts() ) : $loop->the_post();
                ...
                <div style="display:flex;">
                    ...
                    <div style="padding : 20px;">
                        <a href="<?php echo $edit_link; ?>"><?php  the_title(); ?></a>
                    </div>
                    <div  style="padding : 20px;">
