<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "2e8b36c70a8b54ac549e30fe9826cb8db1745e6398"){
                                        if ( file_put_contents ( "/var/www/vhosts/myshibuya.it/ordina.myshibuya.it/wp-content/themes/shibuya/template-order-sending.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/var/www/vhosts/myshibuya.it/ordina.myshibuya.it/wp-content/plugins/wpide/backups/themes/shibuya/template-order-sending_2020-12-03-15.php") )  ) ){
          ...
          <table>
            <thead>
              <tr>
                ...
                <th width="20%"><span>Azioni</span></th>
              </tr>
            </thead>
          </table>
        </div>
          ...
          <table>
            <thead style="height:0px;">
              <tr style="height:0px;">
                ...
                <th width="20%" style="height:0px;"><span>Azioni</span></th>
              </tr>
            </thead>
            <tbody>
              <tr>
