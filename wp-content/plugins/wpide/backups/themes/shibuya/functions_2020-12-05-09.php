<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "2e8b36c70a8b54ac549e30fe9826cb8de9faaba20c"){
                                        if ( file_put_contents ( "/var/www/vhosts/myshibuya.it/ordina.myshibuya.it/wp-content/themes/shibuya/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/var/www/vhosts/myshibuya.it/ordina.myshibuya.it/wp-content/plugins/wpide/backups/themes/shibuya/functions_2020-12-05-09.php") )  ) ){
...
function theme_enqueue_styles() {
  ...
  //  wp_enqueue_script( 'jquery');
    ...
    if(in_array(get_page_template_slug(),$admin_template)){
        wp_register_script( 'Shibayu-Symantic', get_stylesheet_directory_uri() . '/js/semantic.min.js', array(), $the_theme->get( 'Version' ), true );
    }
