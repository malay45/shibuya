...
gulp.task( 'watch', function() {
    ...
    gulp.watch( [`${paths.dev}/js/**/*.js`, 'js/**/*.js', '!js/app.js', '!js/app.min.js'], gulp.series('scripts') );
...
gulp.task( 'scripts', function() {
    var scripts = [
        ...
        `${paths.dev}/js/jquery/jquery.js`,

        `${paths.dev}/js/bootstrap4/bootstrap.bundle.js`,

        `${paths.dev}/js/greensock/gsap.min.js`,

        `${paths.dev}/js/ScrollMagic/ScrollMagic.min.js`,

        `${paths.dev}/js/ScrollMagic/animation.gsap.min.js`,
        
        `${paths.dev}/js/ScrollMagic/debug.addIndicators.min.js`,

        `${paths.dev}/js/cookie-banner/jquery.cookie-banner.js`,
        
        `${paths.dev}/js/micromodal/micromodal.min.js`,

        `${paths.dev}/js/smooth-scroll/smooth-scroll.min.js`,

        `${paths.dev}/js/smooth-scroll/smooth-scroll.polyfills.min.js`,

        `${paths.dev}/js/select2/select2.full.min.js`,
