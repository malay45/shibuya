                            ...
                            <form action="">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <span class="txt">* Accetto la Politica sulla <a target="_blank" href="https://www.iubenda.com/privacy-policy/71785263">privacy</a> e i <a target="_blank" href="/termini-utilizzo">Termini di utilizzo</a> di My Shibuya</span>
                                ...
                                <div class="row">
                                    <div class="col-12 padding-15">
                                        <div class="Flex-col space-between align-items"> 
                                            <span class="txt">Desidero ricevere novità e promozioni e accetto la vostra <a target="_blank" href="https://www.iubenda.com/privacy-policy/71785263">Privacy Policy</a></span>
                                            <div class="form-group margin-0">
                            ...
                            <div class="col-sm-6 col-12">
                                ...
                                ?>
                                    ...
                                    <input name="" class="pickup_date form-control"
                                        ...
                                        data-dd-default-date="<?php echo date('m/d/Y',strtotime("+".$dates['starting_day']." day")) ?>"
                                         value="<?php echo strftime("%e %B %Y",strtotime("+".$dates['starting_day']." day")) ?>" 
                                    />
                                    <input type="hidden" name="pickup_date" class=" form-control" id="pickup_date" value="<?php echo date('Y-m-d',strtotime("+".$dates['starting_day']." day")) ?>" />
                                </div>
                            </div>
                        </div>
